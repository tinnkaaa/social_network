    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Користувач'), ('moderator', 'Модератор'), ('admin', 'Адміністратор')], default='user', max_length=10, verbose_name='Роль')),
                ...
                ('last_activity', models.DateTimeField(blank=True, null=True, verbose_name='Остання активність')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', 'чоловік'), ('female', 'жінка')], max_length=6, verbose_name='Стать')),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user'], name='auth_system_user_id_6a10ec_idx')],
            },
        ),
    ]
